...
Gem::Specification.new do |s|
  ...
  s.files = [%q{.gitignore}, %q{CHANGES}, %q{Gemfile}, %q{LICENSE}, %q{README.rdoc}, %q{Rakefile}, %q{VERSION}, %q{lib/more_math.rb}, %q{lib/more_math/cantor_pairing_function.rb}, %q{lib/more_math/constants/functions_constants.rb}, %q{lib/more_math/continued_fraction.rb}, %q{lib/more_math/distributions.rb}, %q{lib/more_math/exceptions.rb}, %q{lib/more_math/functions.rb}, %q{lib/more_math/histogram.rb}, %q{lib/more_math/linear_regression.rb}, %q{lib/more_math/newton_bisection.rb}, %q{lib/more_math/numberify_string_function.rb}, %q{lib/more_math/sequence.rb}, %q{lib/more_math/string_numeral.rb}, %q{lib/more_math/version.rb}, %q{more_math.gemspec}, %q{tests/test_analysis.rb}, %q{tests/test_cantor_pairing_function.rb}, %q{tests/test_continued_fraction.rb}, %q{tests/test_distribution.rb}, %q{tests/test_functions.rb}, %q{tests/test_histogram.rb}, %q{tests/test_newton_bisection.rb}, %q{tests/test_numberify_string_function.rb}]
  s.homepage = %q{http://github.com/flori/more_math}
